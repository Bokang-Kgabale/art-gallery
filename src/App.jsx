    ...
    <div style={{ width: '100vw', height: '100vh', background: '#0a090a' }}>
      ...
      <motion.button
        ...
        style={{
          ...
          background: hudVisible ? 'rgba(0, 0, 0, 0.5)' : 'rgba(200, 169, 110, 0.85)',
          backdropFilter: 'blur(8px)',
          color: hudVisible ? 'rgba(255, 255, 255, 0.8)' : '#0f0e0f',
          border: hudVisible ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid rgba(200, 169, 110, 1)',
          padding: '10px 20px',
          borderRadius: '24px',
          cursor: 'pointer',
          fontSize: '11px',
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = '0 6px 25px rgba(200, 169, 110, 0.2)'
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.background = hudVisible ? 'rgba(0, 0, 0, 0.5)' : 'rgba(200, 169, 110, 0.85)'
          e.currentTarget.style.color = hudVisible ? 'rgba(255, 255, 255, 0.8)' : '#0f0e0f'
          e.currentTarget.style.borderColor = hudVisible ? 'rgba(255, 255, 255, 0.1)' : 'rgba(200, 169, 110, 1)'
      ...
      {/* ── Controls HUD — fades when artwork selected or HUD disabled ─────────── */}
      <motion.div
